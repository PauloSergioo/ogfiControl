...
INSERT INTO tb_document (document_type, document_name, sent_date, description, project_id) VALUES ('Contrato', 'Contrato de Prestação de Serviços', '2023-02-10', 'Um acordo formal entre o proprietário e a empresa de construção que estabelece os termos, condições e responsabilidades relacionadas à construção.', 1);
INSERT INTO tb_document (document_type, document_name, sent_date, description, project_id) VALUES ('Contrato', 'Contrato de Construção de Edificio', '2023-03-05', 'Um acordo formal entre o proprietário e a empresa de construção que estabelece os termos, condições e responsabilidades relacionadas à construção.', 1);
INSERT INTO tb_document (document_type, document_name, sent_date, description, project_id) VALUES ('Contrato', 'Contrato de Construção de Civil', '2023-04-20', 'Um acordo formal entre o proprietário e a empresa de construção que estabelece os termos, condições e responsabilidades relacionadas à construção.', 2);
INSERT INTO tb_document (document_type, document_name, sent_date, description, project_id) VALUES ('Contrato', 'Contrato de Prestação de Serviços', '2023-05-15', 'Um acordo formal entre o proprietário e a empresa de construção que estabelece os termos, condições e responsabilidades relacionadas à construção.', 2);
INSERT INTO tb_document (document_type, document_name, sent_date, description, project_id) VALUES ('Contrato', 'Contrato de Construção Civil', '2023-06-10', 'Um acordo formal entre o proprietário e a empresa de construção que estabelece os termos, condições e responsabilidades relacionadas à construção.', 3);
