...
INSERT INTO tb_project (project_name, location, budget, start_date, estimated_completion_date, description) VALUES ('Project 1', 'Location 1', 100000.00, '2023-01-01', '2023-12-31', 'Project 1 description');
INSERT INTO tb_project (project_name, location, budget, start_date, estimated_completion_date, description) VALUES ('Project 2', 'Location 2', 150000.00, '2024-01-01', '2024-12-31', 'Project 2 description');
INSERT INTO tb_project (project_name, location, budget, start_date, estimated_completion_date, description) VALUES ('Project 3', 'Location 3', 80000.00, '2023-03-01', '2023-11-30', 'Project 3 description');
INSERT INTO tb_project (project_name, location, budget, start_date, estimated_completion_date, description) VALUES ('Project 4', 'Location 4', 120000.00, '2024-02-15', '2024-10-31', 'Project 4 description');
INSERT INTO tb_project (project_name, location, budget, start_date, estimated_completion_date, description) VALUES ('Project 5', 'Location 5', 90000.00, '2023-06-01', '2023-09-30', 'Project 5 description');
...
INSERT INTO tb_risk (description, probability, impact, project_id) VALUES ('Risk 1 description', 0.2, 0.4, 1);
INSERT INTO tb_risk (description, probability, impact, project_id) VALUES ('Risk 2 description', 0.3, 0.5, 1);
INSERT INTO tb_risk (description, probability, impact, project_id) VALUES ('Risk 3 description', 0.1, 0.2, 2);
INSERT INTO tb_risk (description, probability, impact, project_id) VALUES ('Risk 4 description', 0.4, 0.6, 2);
INSERT INTO tb_risk (description, probability, impact, project_id) VALUES ('Risk 5 description', 0.5, 0.3, 3);
